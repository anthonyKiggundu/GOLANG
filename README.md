...
## Background
These adjustments to the code were motivated by a request for extensions to the metribeats module as raised in the [following post](https://github.com/elastic/beats/issues/3608)
